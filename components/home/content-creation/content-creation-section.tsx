    ...
    <section className="py-20 bg-white dark:bg-slate-900">
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          ...
          >
            Use our AI-powered tools to generate content
          </motion.p>
        </div>
          ...
          >
            <Card className="p-6 h-full hover:shadow-lg transition-shadow bg-white/5 backdrop-blur-lg border-white/10">
              <div className="flex flex-col items-center text-center">
                ...
                <h3 className="text-xl font-semibold mb-2">Content Creation Tool</h3>
                <p className="text-slate-600 dark:text-slate-300">
                  Use our AI-powered tool to generate content
                </p>
